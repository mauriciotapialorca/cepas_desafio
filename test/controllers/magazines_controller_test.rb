...
class MagazinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create magazine" do
    assert_difference("Magazine.count") do
      post magazines_url, params: { magazine: { job_tittle: @magazine.job_tittle, tittle: @magazine.tittle } }
    end
  ...
  test "should update magazine" do
    patch magazine_url(@magazine), params: { magazine: { job_tittle: @magazine.job_tittle, tittle: @magazine.tittle } }
